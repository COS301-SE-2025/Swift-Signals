...
const file_user_proto_rawDesc = "" +
	...
	"\vUserService\x12=\n" +
	"\fRegisterUser\x12\x19.user.RegisterUserRequest\x1a\x12.user.UserResponse\x127\n" +
	"\tLoginUser\x12\x16.user.LoginUserRequest\x1a\x12.user.AuthResponse\x12;\n" +
	"\n" +
	"LogoutUser\x12\x17.user.LogoutUserRequest\x1a\x14.user.LogoutResponseBHZFgithub.com/COS301-SE-2025/Swift-Signals/api-gateway/protos/user;userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.LogoutUser:input_type -> user.LogoutUserRequest
	3, // 3: user.UserService.RegisterUser:output_type -> user.UserResponse
	4, // 4: user.UserService.LoginUser:output_type -> user.AuthResponse
	5, // 5: user.UserService.LogoutUser:output_type -> user.LogoutResponse
