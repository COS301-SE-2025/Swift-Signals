...
func (suite *TestSuite) TestUpdateUserByID_Success() {
	...
	suite.service.On("UpdateUserByID", mock.Anything, "test-user-id", expectedRequest.Username, expectedRequest.Email).
		Return(expectedUser, nil)

	body, _ := json.Marshal(expectedRequest)
	req := httptest.NewRequest(http.MethodPatch, "/admin/users/test-user-id", bytes.NewBuffer(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "test-user-id")
	req = req.WithContext(suite.ctx)
	w := httptest.NewRecorder()

	suite.handler.UpdateUserByID(w, req)
...
func (suite *TestSuite) TestUpdateUserByID_EmptyPathValue() {
	...
	req := httptest.NewRequest(http.MethodPatch, "/admin/users/", bytes.NewBuffer(body))
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "")
	req = req.WithContext(suite.ctx)
	w := httptest.NewRecorder()
	...
	suite.service.AssertNotCalled(suite.T(), "UpdateUserByID")
}

func (suite *TestSuite) TestUpdateUserByID_InvalidJSON() {
...
func (suite *TestSuite) TestUpdateUserByID_ValidationError_UsernameTooShort() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ValidationError_UsernameTooLong() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ValidationError_InvalidEmail() {
	requestBody := model.UpdateUserRequest{
		Username: "validuser",
...
func (suite *TestSuite) TestUpdateUserByID_PartialUpdate_UsernameOnly() {
	requestBody := model.UpdateUserRequest{
	...
	suite.service.On("UpdateUserByID", mock.Anything, "test-user-id", requestBody.Username, requestBody.Email).
		Return(expectedUser, nil)
...
func (suite *TestSuite) TestUpdateUserByID_PartialUpdate_EmailOnly() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ServiceNotFound() {
	requestBody := model.UpdateUserRequest{
		Username: "updateduser",
		Email:    "updated@example.com",
	}
	...
	suite.service.On("UpdateUserByID", mock.Anything, "nonexistent-id", requestBody.Username, requestBody.Email).
...
func (suite *TestSuite) TestUpdateUserByID_ServiceForbiddenError() {
	requestBody := model.UpdateUserRequest{
		Username: "updateduser",
		Email:    "updated@example.com",
	}
...
func (suite *TestSuite) TestUpdateUserByID_ServiceInternalError() {
	requestBody := model.UpdateUserRequest{
		Username: "updateduser",
		Email:    "updated@example.com",
	}
...
func (suite *TestSuite) TestUpdateUserByID_ServiceValidationError() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ServiceAlreadyExistsError() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ServiceUnauthorizedError() {
	requestBody := model.UpdateUserRequest{
		Username: "updateduser",
		Email:    "updated@example.com",
	}
...
func (suite *TestSuite) TestUpdateUserByID_NilBody() {
	req := httptest.NewRequest(http.MethodPatch, "/admin/users/test-user-id", nil)
	req.Header.Set("Content-Type", "application/json")
	req.SetPathValue("id", "test-user-id")
	req = req.WithContext(suite.ctx)
	w := httptest.NewRecorder()
...
func (suite *TestSuite) TestUpdateUserByID_MinimalValidUsername() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_MaximalValidUsername() {
	requestBody := model.UpdateUserRequest{
...
func (suite *TestSuite) TestUpdateUserByID_ResponseHeadersSet() {
	requestBody := model.UpdateUserRequest{
		Username: "testuser",
