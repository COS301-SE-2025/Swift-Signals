...
const TrafficLight = ({
  ...
  return (
    <div className="traffic-light bg-gradient-to-b from-neutral-800 to-neutral-900 via-neutral-900 p-4 rounded-xl shadow-2xl flex flex-col space-y-4 w-30 items-center border border-neutral-700/70">
      <div
        className={`${baseLightClasses} ${redActive ? activeBorderColor : inactiveBorderColor} ${redActive ? activeRed : inactiveRed}`}
      >
        {redActive && (
      ...
      <div
        className={`${baseLightClasses} ${yellowActive ? activeBorderColor : inactiveBorderColor} ${yellowActive ? activeYellow : inactiveYellow}`}
      >
        {yellowActive && (
      ...
      <div
        className={`${baseLightClasses} ${greenActive ? activeBorderColor : inactiveBorderColor} ${greenActive ? activeGreen : inactiveGreen}`}
      >
        {greenActive && (
...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen w-full h-full flex flex-col sm:flex-row items-center justify-center font-sans  from-slate-100 to-sky-100">
      ...
      >
        <h1 className="signUpTitle text-4xl font-bold text-center text-gray-800 mb-8">
          Sign Up
        </h1>
